...
/**Si no se envÃ­a idioma el idioma por defecto es ES*/
...
/*FunciÃ³n para establecer el valor de la cookie*/
function setCookie(name, value, days) {
    ...
    //document.cookie = name + "=" + (value || "")  + expires + "; path=/";
    //document.cookie = name + "=" + value + "; expires = "  + expires + "; SameSite = none";
